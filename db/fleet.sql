...
insert  into `assigneemapper`(`id`,`userID`,`assigneeID`,`companyID`,`type`,`isshow`,`createdBy`,`createdDate`,`modifiedBy`,`modifiedDate`) values ('UA00000001','alladinx','ASS00000008',NULL,'user_assignee',1,'alladinx','2015-08-24 05:58:14',NULL,NULL),('AC00000001','','ASS00000008','COM0001','assignee_company',1,'alladinx','2015-09-20 10:55:16',NULL,NULL),('AC00000003',NULL,'ASS00000008','COM0002','assignee_company',0,'alladinx','2015-09-20 11:05:26',NULL,NULL),('AC00000004',NULL,'ASS00000008','COM0003','assignee_company',0,'alladinx','2015-09-20 11:17:57',NULL,NULL),('AC00000005',NULL,'ASS00000009','COM0003','assignee_company',1,'alladinx','2015-09-20 11:18:10',NULL,NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_assigneecompanymapper` AS (select `assigneemapper`.`id` AS `id`,`assigneemapper`.`assigneeID` AS `assigneeID`,`v_assigneemaster`.`assigneeName` AS `assigneeName`,`assigneemapper`.`companyID` AS `companyID`,`v_companymaster`.`companyName` AS `companyName`,`v_companymaster`.`companyLogo` AS `companyLogo`,`assigneemapper`.`type` AS `type`,`assigneemapper`.`isshow` AS `isShow`,`assigneemapper`.`createdBy` AS `createdBy`,`assigneemapper`.`createdDate` AS `createdDate`,`assigneemapper`.`modifiedBy` AS `modifiedBy`,`assigneemapper`.`modifiedDate` AS `modifiedDate` from ((`assigneemapper` join `v_assigneemaster` on((`v_assigneemaster`.`assigneeID` = `assigneemapper`.`assigneeID`))) join `v_companymaster` on((`v_companymaster`.`companyID` = `assigneemapper`.`companyID`))) where (`assigneemapper`.`type` = _latin1'assignee_company')) */;

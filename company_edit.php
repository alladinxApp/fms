<? 
    ...
    require_once(MODEL_PATH . COMPANY_MODEL);
    require_once(CONTROLLER_PATH . COMPANY_CONTROLLER);
...
<body class="admin-elements-page" data-spy="scroll" data-target="#nav-spy" data-offset="300">
            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <div class="tray tray-center ph30 va-t posr animated-delay animated-long" data-animate='["<?=$data_animate_time;?>","<?=$data_animate_type;?>"]'>
                    <div class="mw1100 center-block">
                        ...
                        <? require_once(VIEW_PATH . V_COMPANYEDIT); ?>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            ...
            $('#txtInsuranceReminderInDays,#txtDaysOfNotification').priceFormat({
                clearPrefix: true,
                prefix: '',
                centsSeparator: '',
                thousandsSeparator: ',',
            ...
            $("#txtInsuranceAppliedDate,#txtPurchaseDate").datepicker({
                dateFormat: 'yy-mm-dd',
                maxDate: 0
            });

            $("#txtInsuranceExpirationDate").datepicker({
                dateFormat: 'yy-mm-dd',
                minDate: 0
            });
            ...
            $( "#company-form" ).validate({
                ...
                messages:{
                    ...
                    txtCompanyContactNo: {
                        required: 'Please enter company contact no!'
                    },
                    txtDaysInNotification: {
                        required: 'Please enter days in notification!'
                    },
                    // txtInsuranceAppliedDate: {
                    ...
                    // ,
                    // txtCompanyLogo: {
                    //     required: 'Please choose a company logo!'
                    // }
                    // ,
                    // txtCompanySignature: {
                    //     required: 'Please chosse a company signature!'
                    // }
                }
            });
        });

<? 
    ...
    require_once(MODEL_PATH . PARTS_MODEL);
    require_once(CONTROLLER_PATH . PARTS_CONTROLLER);
...
<body class="admin-elements-page" data-spy="scroll" data-target="#nav-spy" data-offset="300">
            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <div class="tray tray-center ph30 va-t posr animated-delay animated-long" data-animate='["<?=$data_animate_time;?>","<?=$data_animate_type;?>"]'>
                    <div class="mw1100 center-block">
                        ...
                        <? require_once(VIEW_PATH . V_PARTSEDIT); ?>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            $('#txtLowStockQty,#txtStockOnHand').priceFormat({
                clearPrefix: true,
                prefix: '',
                centsSeparator: '',
                thousandsSeparator: ',',
            ...
            $('#txtPrice,#txtRetailPrice').priceFormat({
                clearPrefix: true,
                prefix: '',
                centsSeparator: '.',
                thousandsSeparator: ','
            ...
            $( "#parts-form" ).validate({
                ...
                messages:{
                    ...
                    txtStockOnHand: {
                        required: 'Please enter stock on hand!'
                    },
                    txtLowStockQty: {
                    ...
                    txtRetailPrice: {
                        required: 'Please enter retial price!'
                    }
                }
            });     
        });

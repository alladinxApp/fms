<? 
    ...
    require_once(MODEL_PATH . SUPPLIER_MODEL);
    require_once(CONTROLLER_PATH . SUPPLIER_CONTROLLER);
            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <div class="tray tray-center ph30 va-t posr animated-delay animated-long" data-animate='["<?=$data_animate_time;?>","<?=$data_animate_type;?>"]'>
                    <div class="mw1100 center-block">
                        ...
                        <? require_once(VIEW_PATH . V_SUPPLIEREDIT); ?>
        ...
        jQuery(document).ready(function() {
            ...
            $( "#supplier-form" ).validate({
                ...
                messages:{
                    ...
                    txtSupplierContactNo: {
                            required: 'Please enter supplier contact no!'
                    },
                    txtSupplierEmailAddress: {
                            required: 'Please enter supplier email address!'
                    },
                    txtSupplierContactPerson: {
                            required: 'Please enter supplier contact person!'
                    },
                    txtSupplierTIN: {
                            required: 'Please enter supplier TIN!'
                    }
                }
            });     
        });

...
<header class="navbar navbar-fixed-top bg-light">
    <div class="navbar-branding">
        <a class="navbar-brand" href="index.php"> <? $img = new Image('imgs/fms_logo.png',150); ?> </a>
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <? 
            require_once(INCLUDE_PATH . "_notifications.php");
            require_once(INCLUDE_PATH . "_reminders.php");
        ?>

        <!-- <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <span class="flag-xs flag-ph"></span>
                <span class="fw600">PH</span>
            </a>
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="<?=$_SESSION['SYS_AVATAR'];?>" alt="avatar" class="mw30 br64 mr15">
                <span><?=$_SESSION['SYS_UNAME'];?></span>
            ...
            <ul class="dropdown-menu dropdown-persist pn w250 bg-white" role="menu">
                ...
                <li class="br-t of-h">
                    <a href="user_changepassword.php" class="fw600 p12 animated animated-short fadeInDown">

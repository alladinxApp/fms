<? 
    ...
    require_once(MODEL_PATH . MENU_MODEL);
    require_once(CONTROLLER_PATH . MENU_CONTROLLER);
...
<body class="admin-elements-page" data-spy="scroll" data-target="#nav-spy" data-offset="300">
            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <div class="tray tray-center ph30 va-t posr animated-delay animated-long" data-animate='["<?=$data_animate_time;?>","<?=$data_animate_type;?>"]'>
                    <div class="mw1100 center-block">
                        ...
                        <? require_once(VIEW_PATH . V_MENUEDIT); ?>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            ...
            $('#txtIsMenuMaintenance').multiselect();
            $('#txtIsMenuTransaction').multiselect();
            $('#txtIsMenuReport').multiselect();
            ...
            $( "#menu-form" ).validate({
                ...
                messages:{
                    ...
                    txtGlyphicon: {
                            required: 'Please enter CSS glyphicon!'
                    },
                    txtSortNo: {

<? 
    ...
    require_once(MODEL_PATH . REMINDERS_MODEL);
    require_once(CONTROLLER_PATH . REMINDERS_CONTROLLER);
            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <div class="tray tray-center ph30 va-t posr animated-delay animated-long" data-animate='["<?=$data_animate_time;?>","<?=$data_animate_type;?>"]'>
                    <div class="mw1100 center-block">
                        ...
                        <? require_once(VIEW_PATH . V_REMINDERSEDIT); ?>
        ...
        jQuery(document).ready(function() {
			...
			$("#txtStartDate").datepicker({
                ...
                onSelect: function(selected) {
                  $("#txtDueDate").datepicker("option","minDate", selected)
                }
            });
            ...
            $("#txtFromDt").datepicker({
                dateFormat: 'yy-mm-dd',
                onSelect: function(selected) {
                  $("#txtToDt").datepicker("option","minDate", selected)
                }
            });
            $("#txtToDt").datepicker({
                dateFormat: 'yy-mm-dd',
                onSelect: function(selected) {
                   $("#txtFromDt").datepicker("option","maxDate", selected)
                }
            });
